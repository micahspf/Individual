    ...
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="space-y-5 leading-relaxed text-neutral-300">
        ...
        <p>
          ...
          equivalent. Rates are calculated at checkout or quoted with your commission. Free
          shipping thresholds may apply on qualifying orders.
        </p>
        <p className="text-sm text-neutral-500">
          Note: Final rates and free-shipping thresholds are confirmed on each order as the
          shop launches.
        </p>
      </div>
    </main>

  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="space-y-5 text-neutral-300 leading-relaxed">
        <p>
          Because every piece is made to order, returns are limited. If we made an error (wrong engraving, defective print, damage in transit), we’ll make it right — repair, remake, or refund.
        </p>
        <p>

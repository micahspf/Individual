...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: "fidget-sensory",
    description:
      "Smooth single-piece desk slider. Optional engraved monogram for a subtle personalized desk tool. Ages 13+.",
    materials: "Polymer or flexible polymer",
    turnaround: "7–10 days",
    image: img("fidget-slider"),
    personalize: ["Optional monogram or initials"],
    occasions: ["Desk gift", "Everyday"],
  },
  {
    id: "9",
    ...
    category: "fidget-sensory",
    description:
      "Compact desk board with multiple mechanisms. Clean accessory for focus at work or study. Ages 13+.",
    materials: "Polymer",
    turnaround: "7–10 days",
    image: img("fidget-board"),
    personalize: ["Optional engraved initials on base"],
    occasions: ["Desk gift", "Office"],
  },
  {
    id: "5",
...
export const giftOccasions = [
  ...
  { label: "Everyday personal", href: "/shop?cat=drinkware", hint: "Name, monogram, coordinates" },
